  ...
  <div className="container">
    ...
    <div className="services">
      ...
      <div className="column" id="column-1">
        <div className="service">
          <div className="service-desc">
            <i className="service-icon fas fa-flask">

            </i>
            <p className="service-txt">
              bussiniss intelegince  
            </p>                       
          </div>
        </div>
        <div className="service">
          <div className="service-desc">
            <i className="service-icon fas fa-bullhorn">
        ...
        <div className="service">
          <div className="service-desc">
            <i className="service-icon far fa-lightbulb">
      ...
      <div className="column" id="column-2">
        <div className="service">
          <div className="service-desc">
            <i className="service-icon fas fa-wrench">
        ...
        <div className="service">
          <div className="service-desc">
            <i className="service-icon fas fa-database">
        ...
        <div className="service">
          <div className="service-desc">
            <i className="service-icon fas fa-chart-pie">
      ...
      <div className="column" id="column-2">
        <div className="service">
          <div className="service-desc">
            <i className="service-icon fas fa-tasks">
        ...
        <div className="service">
          <div className="service-desc">
            <i className="service-icon fas fa-certificate">
